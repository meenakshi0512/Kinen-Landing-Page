          ...
          <div class="content-circle">
            ...
            <div class="dress-main">
               <div class="dress-detail">
                   <img src={require("./assets/dress1.jpg")} alt='dress1' class="dress-detail-image"/>
                   <b>Long Blazer</b>
                   <br/>
                   <b>$150.38</b>
               </div>
               <div class="dress-detail">
                   <img src={require("./assets/dress2.jpg")} alt='dress2' class="dress-detail-image"/>
                   <b>White Pant</b>
                   <br/>
                   <b>$80.38</b>
               </div>
               <div class="dress-detail">
                   <img src={require("./assets/dress3.jpg")} alt='dress3' class="dress-detail-image"/>
                   <b>Leather shoes</b>
                   <br/>
                   <b>$175.38</b>
               </div>
